...
@Component({
  selector: 'app-sty-des-product-detail-by-colour',
  templateUrl: './sty-des-product-detail-by-colour.component.html',
  styleUrls: ['./sty-des-product-detail-by-colour.component.css']
})
export class StyDesProductDetailByColourComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.route.params.subscribe(params => {
      ...
      this.ManufacturerService.getProducts_images(this.product_id ,this.colour_id).toPromise()
      .then(response => {
