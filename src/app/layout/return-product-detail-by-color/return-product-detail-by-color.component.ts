...
@Component({
  selector: 'app-return-product-detail-by-color',
  templateUrl: './return-product-detail-by-color.component.html',
  styleUrls: ['./return-product-detail-by-color.component.css']
})
export class ReturnProductDetailByColorComponent implements OnInit {
  errormessage;
